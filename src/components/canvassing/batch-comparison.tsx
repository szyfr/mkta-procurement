...
export function BatchComparison({
    ...
    const lowest = batch.quotes.reduce<
        CanvassingBatch["quotes"][number] | null
    >(
        (cheapest, quote) =>
            cheapest === null || quote.total < cheapest.total
                ? quote
                : cheapest,
        null,
    );
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div className="flex flex-col gap-0.5">
                    ...
                    <p className="text-xs text-muted-foreground">
                        ...
                        for shared vendor sourcing
                    </p>
                </div>
                <div className="flex flex-wrap items-center gap-2">
                    <StatusBadge
                        tone={
                            batch.quotesReceived >= batch.quotesRequired
                                ? "neutral"
                                : "info"
                        }
                    >
                        {batch.quotesReceived} of {batch.quotesRequired} minimum
                        quotes received
                    </StatusBadge>
                    <Button
                        variant="outline"
                    ...
                    <CardContent>
                        <Empty>
                            <EmptyHeader>
                                ...
                                <EmptyDescription>
                                    No quotes have been entered for this batch
                                    yet. Add a vendor quote to start the
                                    comparison.
                                </EmptyDescription>
                            </EmptyHeader>
                            <EmptyContent>
                        ...
                        <CardFooter className="flex-col items-stretch gap-3">
                            ...
                            <div className="flex justify-end">
                                <Button
                                    size="sm"
                                    disabled={
                                        !selectedQuote || selectVendor.isPending
                                    }
                                    onClick={() =>
                                        selectedQuote &&
                                        selectVendor.mutate({
