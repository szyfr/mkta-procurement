...
export function CanvassingDetailView({ id }: { id: string }) {
  ...
  if (isPending) {
    return (
      <>
        <PageHeader title={`Canvassing — ${id}`} description="Loading…" />
        <Card>
    ...
    return (
      <Empty>
        <EmptyHeader>
          ...
          <EmptyDescription>
            This purchase request does not exist, or it has no items out for
            quotation.
          </EmptyDescription>
        </EmptyHeader>
        <EmptyContent>
              ...
              <Card>
                <CardContent className="grid gap-4 text-xs sm:grid-cols-2 lg:grid-cols-4">
                  ...
                  <div>
                    ...
                    <p>
                      {batch.quotesReceived} / {batch.quotesRequired} minimum
                    </p>
                  </div>
                  <div>
