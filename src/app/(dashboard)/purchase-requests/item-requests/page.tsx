...
export default function ItemCreationRequestsPage() {
    return (
        <>
            <Alert>
                <AlertDescription>
                    Reached from a link inside Purchase Requests (not a sidebar
                    tab) — this only tracks requests created while building a
                    PR, or created directly here for master-data cases (new
                    SKUs, materials) that aren&apos;t tied to a specific
                    purchase yet.
                </AlertDescription>
            </Alert>
